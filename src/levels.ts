...
const level1 = Collection.of<Car>([
									  new Car(1, Type.PLAYER, Color.RED, [31, 32]),
									  new Car(2, Type.CAR, Color.YELLOW, [11, 12, 13]),
									  new Car(3, Type.CAR, Color.MARINE, [23, 33]),
									  new Car(4, Type.CAR, Color.PURPLE, [15, 25, 35]),
									  new Car(5, Type.CAR, Color.BLUE, [41, 51]),
									  new Car(6, Type.CAR, Color.PINK, [42, 43]),
									  new Car(7, Type.CAR, Color.ORANGE, [44, 45]),
									  new Car(8, Type.CAR, Color.GREEN, [36, 46]),
									  new Car(9, Type.CAR, Color.GRAPEFRUIT, [56, 66]),
									  new Car(10, Type.CAR, Color.PURPLE, [52, 53]),
									  new Car(11, Type.CAR, Color.MARINE, [61, 62, 63]),
									  new Car(12, Type.CAR, Color.BLUE, [54, 64]),
								  ]);
...
// Level 31
const level6 = Collection.of<Car>([
									  new Car(1, Type.PLAYER, Color.RED, [32, 33]),
